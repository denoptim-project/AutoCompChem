...
/**
 * Contract defining the minimal set of method for classes aiming to write
 * input files (or set of files) for software packages.
 *
 * @author Marco Foscato
 */

public abstract interface ITextualInputWriter
{
