...
//------------------------------------------------------------------------------
    ...
    public Set<Task> getCapabilities() {
    	//TODO-gg change to analyzeSpartanOutput: make it based on OrcaOuputReader
        return Collections.unmodifiableSet(new HashSet<Task>(
        		//TODO-gg commented out to allow testing of help msgs: reactivate
...
//-----------------------------------------------------------------------------
    ...
    /**
     * Constructs an SpartanOutputHandler specifying the parameters
