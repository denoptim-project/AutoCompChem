...
//TODO-gg like ConstrainDefinition make subclass of AtomTupleMatchingRule
public class ConformationalMoveDefinition 
{
    /**
...
//------------------------------------------------------------------------------
    ...
    public ConformationalMoveDefinition(String txt, int i)
    {
...
//------------------------------------------------------------------------------
	 ...
	 * i-j-k-l.
  	 ...
  	 */
  	//TODO-gg private?
  	public ConformationalCoordinate makeConformationalCoordinate(
  			...
  			throws Exception 
  	{
  		//TODO-gg use 
  		/*
  		ConformationalCoordinate(String refName, String type, 
        ArrayList<IAtom> atomDef, ArrayList<Integer> atomIdDef,
        double value, int fold)
        */
  		return new ConformationalCoordinate();
  	}
