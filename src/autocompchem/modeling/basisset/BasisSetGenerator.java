...
public class BasisSetGenerator
{
    /**
    ...
    /**
     * List of atom-matching rules for assigniation of the basis sets
     */
    ...
    /**
     * Flag setting tolerance for patial matches
     */
...
//------------------------------------------------------------------------------
    ...
    /**
     * Constructor for an empty BasisSetGenerator
     */
...
//------------------------------------------------------------------------------
    ...
    /**
     * Constructs a BasisSetGenerator specifying the parameters taken from 
     * formatted file or generated by other tools.
     * The following {@link autocompchem.parameters.Parameter}s are interpreted by
     * this method if included in the 
     * {@link autocompchem.parameters.ParameterStorage} argument:
     * <br>
     * <ul>
     * <li>
     ...
     * a multi line {@link autocompchem.parameters.Parameter} in the
     ...
     * allows to tollerate partial basis set that do not cover all atoms in the
     ...
     * </li>
     * </ul>
     * @param params object containing all the given parameters
     */

    public BasisSetGenerator(ParameterStorage params) 
    {
        // Define verbosity
...
//------------------------------------------------------------------------------
    ...
    /**
     * Constructs a new BasisSetGenerator specifying all
     * single parameters.
     * @param filename path or name of the input (i.e. name.sdf)
     * @param rules set of rules for assignation of basis set
     * @param outFile name of the output file where result will be written
     * @param verbosity verbosity level
     */

    public BasisSetGenerator(String filename, Map<String,BSMatchingRule> rules,
                             String outFile, int verbosity)
    {
...
//-----------------------------------------------------------------------------
    ...
    /**
     * Return the curretnly loaded Basis Set assigniation rules.
     * @return the list of currently loaded basis set assigniation rules.
     */
