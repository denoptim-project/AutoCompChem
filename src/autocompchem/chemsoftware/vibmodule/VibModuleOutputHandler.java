...
public class VibModuleOutputHandler
{
...
//------------------------------------------------------------------------------
    ...
    public VibModuleOutputHandler(ParameterStorage params) 
    {
        //Define verbosity
...
//------------------------------------------------------------------------------
    ...
    /**
     * Constructs an output handler defining some of its field
     * @param molFile the molecular structure file defining the chemical system
     * @param vmFile the VibModule output file containing the analysis
     * of the chemical system
     * @param smarts the map of SMARTS-based ruled used to match the internal
     * coordinated that correspond to molecular mechanic interaction terms
     * @param smartsOpts the map of options associated to the SMARTS-based rules
     * @param verbosity the verbosity level
     */

    public VibModuleOutputHandler(String molFile, String vmFile, 
            Map<String,String> smarts, Map<String,ArrayList<String>> smartsOpts,
                                                                  int verbosity)
    {
        this.molFile = molFile;
        this.vmFile = vmFile;
        this.smarts = smarts;
        this.smartsOpts = smartsOpts;
