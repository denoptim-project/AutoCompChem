...
public class NWChemOutputHandler
{
    ...
    /**
     * Flag requisting to print vibrational modes
     */
...
System.out.println("FILE: "+this.outFileVibModes);
        }
...
//------------------------------------------------------------------------------
    ...
    /**
     * Constructs a new NWChemOutputHandler specifying the name 
     * (or path) of the
    ...
    public NWChemOutputHandler(String filename, 
