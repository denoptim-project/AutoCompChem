...
/**
 * Comparator for {@link NWChemKeyword}s. This comparator is used to sort
 * the keywords
 ...
 * <a href="http://www.nwchem-sw.org/index.php/Release66:Top-level#TASK">NWChem user manual</a>. Currently the only exception is the order of the keywords in
 * the directive TASK: first the 'theory', then the 'operation' type.
 */

public class NWChemKeywordComparator implements Comparator<NWChemKeyword>
{
    @Override
    public int compare(NWChemKeyword a, NWChemKeyword b)
    {
        final int FIRST = 1;
        final int EQUAL = 0;
        final int LAST = -1;
